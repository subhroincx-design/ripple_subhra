...
function HomeContent() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white text-text-main antialiased selection:bg-primary/20">
      ...
      <div className="flex-1 max-w-5xl w-full mx-auto flex justify-center h-[calc(100vh-53px)] lg:h-screen overflow-hidden">
        {/* Left Column Sidebar */}
        <LeftSidebar
          onScrollToTop={scrollToTop}
          isAdmin={isAdmin}
        ...
        <main
          ...
          className="flex-1 max-w-2xl border-x border-border h-full overflow-y-auto bg-white"
        >
          {/* Top Header Bar */}
          <div className="sticky top-0 z-30 bg-white/80 backdrop-blur-md border-b border-border p-4 flex items-center justify-between">
