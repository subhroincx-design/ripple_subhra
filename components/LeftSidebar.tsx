...
export const LeftSidebar: React.FC<LeftSidebarProps> = ({
  ...
  return (
    <aside className="hidden lg:flex w-64 shrink-0 flex-col justify-between h-screen sticky top-0 py-5 px-4 border-r border-border bg-white select-none">
            ...
            <div className="pt-2">
              <div className="flex items-center justify-between p-3 rounded-2xl bg-emerald-50 border border-emerald-200 text-emerald-800">
                <div className="flex items-center gap-2 text-xs font-bold truncate">
                  ...
                  <span className="truncate">Admin (SUBHRA)</span>
                </div>
                <button
